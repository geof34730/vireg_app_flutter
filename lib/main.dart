...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> readJson({required typeListe,required}) async {
    ...
    setState(() {_choseListVers=true;});
  }

  bool goNextVerb() {
    if (
    controllerFrancais.text.toUpperCase() == StockFrancais.toUpperCase() &&
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
            ...
            body: SingleChildScrollView(child:(_choseListVers
                ? Center(
                    child: Column(
                        ...
                        Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintText: 'Français',
                                  labelText: 'Français',
                                  enabledBorder: OutlineInputBorder(borderSide: BorderSide(width: 2, color: getBorderColor(controllerValue: controllerFrancais.text, stockValue: StockFrancais))),
                                  focusedBorder: OutlineInputBorder(borderSide: BorderSide(width: 2, color: getBorderColor(controllerValue: controllerFrancais.text, stockValue: StockFrancais))),
                        ...
                        Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: 'Infinitif',
                                labelText: 'Infinitif',
                                enabledBorder: OutlineInputBorder(borderSide: BorderSide(width: 2, color: getBorderColor(controllerValue: controllerInfinitif.text, stockValue: StockInfinitif))),
                                focusedBorder: OutlineInputBorder(borderSide: BorderSide(width: 2, color: getBorderColor(controllerValue: controllerInfinitif.text, stockValue: StockInfinitif))),
                        ...
                        Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                enabledBorder: OutlineInputBorder(borderSide: BorderSide(width: 2, color: getBorderColor(controllerValue: controllerPastSimple.text, stockValue: StockPastSimple))),
                                focusedBorder: OutlineInputBorder(borderSide: BorderSide(width: 2, color: getBorderColor(controllerValue: controllerPastSimple.text, stockValue: StockPastSimple))),
                        ...
                        Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                enabledBorder:OutlineInputBorder(borderSide: BorderSide(width: 2, color: getBorderColor(controllerValue: controllerPastParticipe.text, stockValue: StockPastParticipe))),
                                focusedBorder:OutlineInputBorder(borderSide: BorderSide(width: 2, color: getBorderColor(controllerValue: controllerPastParticipe.text, stockValue: StockPastParticipe))),
                            ...
                            child: Row(mainAxisSize: MainAxisSize.min, children: [
                              ...
                              Padding(
                                  ...
                                  child: ElevatedButton.icon(
                                    ...
                                    onPressed: (){readJson(typeListe: ListTypeVerbSelect);},
                                    icon: const Icon(
                                      Icons.check,
                                      size: 19.0,
                                    ),
                ...
                : Center(
                    ...
                    Padding(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: const Text("Les verbes irréguliers les plus utilisés (87)", style: TextStyle(fontSize: 19)),
                        )),
                      Padding(
                        padding: const EdgeInsets.only(left: 50.0, right: 50.0, top: 20.00),
                        child: ElevatedButton.icon(
                          ...
                          label: const Text("Tous Les verbes irréguliers (199)", style: TextStyle(fontSize: 19)),
                        ))
                  ]))))));
  }
}
